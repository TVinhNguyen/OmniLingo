...
const achievements: Achievement[] = [
  ...
  { icon: Globe2, name: "Polyglot", description: "Study 3 languages simultaneously", progress: 3, total: 3, unlocked: true, rarity: "Epic" },
...
export default function AchievementsClient({
  ...
  serverAchievements?: Array<{ code: string; title: string; description: string; icon: string; rarity: string; earnedAt: string | null; xpReward: number }>
}) {
